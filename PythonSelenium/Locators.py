...
# driver.find_element_by_css_selector("input[name='name']:nth-child(2)").send_keys("Chittaranjan Swain")
# This was the old style. Now By class is available, So we can use below.
driver.find_element(By.CSS_SELECTOR, "input[name='name']:nth-child(2)").send_keys("Chittaranjan Swain")
# This above CSS is same as (//input[@name='name'])[1] - When we have multiple results in CSS we use nth-child()
driver.find_element(By.NAME, "email").send_keys("seleniumforchitta@gmail.com")
