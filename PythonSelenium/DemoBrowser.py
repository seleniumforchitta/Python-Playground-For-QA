...
# service_obj = Service("C:/ramARANJAN _SWAIN_D_Drive/STUDY/Software/WebDrivers/geckodriver")
# driver = webdriver.Firefox(service=service_obj)
# service_obj = Service("C:/ramARANJAN _SWAIN_D_Drive/STUDY/Software/WebDrivers/msedgedriver")
